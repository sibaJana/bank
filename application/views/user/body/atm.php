  ...
  <div class="card">
    <div class="flip">
      <div class="front">
        ...
        <?php
        $num = $debitCard[0]->atm_number;
        $parts = str_split($num, 4);
        echo '<div class="card-number">';
        foreach ($parts as $part) {
            echo '<div class="section">' . $part . '</div>';
        }
        echo '</div>';
        ?>
        

        <div class="end"><span class="end-text">exp. end:</span><span class="end-date"><?php $date = new DateTime($debitCard[0]->expire_date);echo $date->format('m/Y');  ?></span></div>
        <div class="card-holder"><?php echo $debitCard[0]->customer_name; ?></div>
        <div class="master">
      ...
      <div class="back">
        ...
        <div class="ccv">
          <label>ccv</label>
          <div><?php echo $debitCard[0]->cvv; ?></div>
        </div>
        <div class="terms">
