            ...
            <div class="card z-index-0">
              ...
              <div class="card-body">
                <form  role="form text-left">
                  ...
                  <p class="text-sm mt-3 mb-0">Already have an account? <a href="<?php echo base_url('Bank/login'); ?>" class="text-dark font-weight-bolder">Sign in</a></p>
                </form>
              </div>
            </div>
          </div>
  ...
  <!-- <script>
    $(document).ready(function(){
        $('#singup').click(function(){
            ...
            $.ajax({
            type: "POST",
            url: "<?php echo base_url('Bank/registration');  ?>",
            data: {name: name,
                    email:email,
                    password:password
            },
       ...
       $('#singup').click(function(){
        ...
        var password=$('#password').val();
            ...
            if(name=="" || email ==""||password== "" ){
              $('#display').html('<div class="alert alert-warning" role="alert">'+'All fild are required'+'</div>');
